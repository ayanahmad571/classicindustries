        ...
        <section class="content">
            ...
            <div class="wraper container-fluid">
                <div class="page-title"> 
                    <h3 class="title">Welcome to <?php echo $_COMPANY['cp_name']; ?> </h3> 
                </div>
                    ...
                    <div class="col-lg-12	">
                        ...
                        <div class="panel panel-default"><!-- /primary heading -->
                            ...
                            <div class="panel-body">
                               <div align="center">
                                                              <img  src="img/OEE-animation.gif" class="img-responsive" />

                               </div>
                               <hr>
                               <a href="sw_proforma.php"><button class="btn btn-lg btn-danger">Make New Bill</button></a> 
                               <a href="inven.php"><button class="btn btn-lg btn-success">Manage Items</button></a> 
                               <a href="sw_clients.php"><button class="btn btn-lg btn-info">Manage Clients</button></a> 
                               <a href="reports.php"><button class="btn btn-lg btn-warning">Reports</button></a> 
                            </div>
                        </div>
                    </div> <!-- end col -->
